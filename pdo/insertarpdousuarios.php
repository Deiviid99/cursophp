...
<body>
    ...
    <form action="../modelo/usuarios.php" method="POST">
        ...
        <label>Usuario: </label>
        <input type="text" name="txtUsuario" id="txtEdad"><br>
        <label>Contraseña: </label>
        <input type="password" name="txtPassword" id="txtEdad"><br>
        <input type="submit" name="btnRegistrar" id="btnRegistrar" value="Guardar"><br>
    </form>
</body>
